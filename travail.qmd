...
sal <- ggplot(salaires |> filter(time >= "1995-01-01")) +
  ...
  ofce_caption(
    ...
    note = "Le salaire est défini comme la masse salariale divisée par l'emploi salarié, sur les 4 derniers trimestres. Le ruban coloré indique les cotisations sociales à la charge de l'employeur.",
    ofce = FALSE)
