...
earn |>
  ...
  La rémunération des moins de 30 ans est en moyenne inférieure de 28% au salaire médian en Italie.  
  <br>
...
dep <- ggplot(dependants) +
  ...
  geom_point_interactive(aes(tooltip = tooltip, data_id = time, y = depse),
                         shape = 21, stroke = 0.1, color = "white", size = 0.5,
                         hover_nearest = TRUE) +
