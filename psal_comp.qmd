  ...
  c("Marchand-L68A" = "mdhim",
    "Marchand-K-L68A" = "mdhimfi"), ~{
      ...
      ggplot(data) +
        ...
        ofce_caption(
          source = "Eurostat, comptes nationaux annuels (nama_10_a64, nama_10_a64_e),
 comptes nationaux trimestriels (namq_10_a10), actifs productifs (nama_10_nfa_st), téléchargés le {date}.",
          code =  "github.com/xtimbeau/travail/vaq.r",
          champ = "Branches marchandes {tolower(.y)}.",
          note = "La CCF ou les impôts nets de subventions proviennent des comptes annuels, jusqu'en 2023 ou 2024 selon les pays, extrapolée au delà. Le partage de la valeur ajoutée pour les derniers points évolue comme le partage dans la valeur ajoutée brute. L'impôt sur les sociétés (D51) des sociétés financières (S12) est affecté à la branche K (services financiers) et celui des sociétés non financières (S11) aux branches marchandes hors services financiers (K) et services immobiliers produits par les ménages (L68A).") })
