...
\begin{titlepage}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \useasboundingbox (0,0) rectangle(\the\paperwidth,\the\paperheight);
      ...
      \node [anchor = east] at (8.5,-12){\textcolor{black}{Modifié le : 2025-11-06}};
...
Francçois Geerolf et Eric Heyer pour leurs remarques stimulantes. Elles
m'ont amené à rendre plus complexe l'exploration des concepts mais la
confusion qui en découle est de ma seule responsabilité.}}
  }
\end{minipage}
\end{titlepage}
\renewcommand*\contentsname{Table des matières}
...
\item
  ...
  pays (graphique~\ref{fig-psalcnc}).
\item
...
la masse salariale que l'on peut imputer aux non salariés. En revanche,
en Allemagne ou en Espagne, c'est potentiellement l'inverse. Le cas
Français est intéressant, parce que le ratio masse salariale imputée sur
revenu mixte devient plus grand que 1 en 2013 et et augmente quelques
années avant. Le régime d'autoentrepreneur introduit en 2008 peut
expliquer cette dynamique en augmentant le nombre de non salariés ayant
de faibles revenus et éventuellement étant salariés par ailleurs.

On peut construire à partir de ces éléments une correction alternative
de la non salarisation en utilisant le revenu mixte\,-- en retenant 90\%
du revenu mixte\footnote{Le chiffre de 90\% est retenu à partir des
  ...
  chaque année (qui varie entre 9,4\% et 13,8\% entre 1995 et 2024).},
le reste pour approcher la CCF\,-- et non le nombre de non salariés
(correction par les effectifs) comme base de la correction.
...
non financières et
financières}\label{comptes-dagents-ou-de-secteurs-institutionnels-entreprise-non-financiuxe8res-et-financiuxe8res}
...
3 annexes (domaine des données, CCF et comparaisons entre pays) sont
accessibles en ligne à l'adresse
