...
crossref:
  custom:
    - key: apptbl
      kind: float
      reference-prefix: tableau annexe
    ...
    - key: appfig
      kind: float
      reference-prefix: graphique annexe
      space-before-numbering: true
      latex-env: appfig
      latex-list-of-file-extension: lost
...
psalE <- imap(
  ...
  ~ggplot(data |> filter(champ == .x)) +
    ...
    theme(legend.direction = "horizontal") +
    scale_color_manual(
      values = c(psal.14 = bluish, psalc = colorspace::lighten(bluish, 0.1), psal.20 = redish),
      name = NULL,
      labels = c(psal.14 = "CNA 2014", psalc = "CNA 2014 (b3g EI)", psal.20 = "CNA 2020"),
...
### Annexe F : Taux de rendement du capital productif en France, 1978-2024 {.unnumbered}
