...
On peut construire à partir de ces éléments une correction alternative de la non salarisation en utilisant le revenu mixte – en retenant 90% du revenu mixte[^1], le reste pour approcher la CCF – et non le nombre de non salariés (correction par les effectifs) comme base de la correction.
