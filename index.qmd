...
psal <- imap(
 ...
 comptes nationaux trimestriels (namq_10_a10), téléchargés le {date}, code à github.com/xtimbeau/travail/R/vaq.r.",
    champ = "{champs[.x]}.",
    note = "Part des salaires dans la Valeur Ajoutée Nette (brute corrigée de la CCF), correction des non salariés par le revenu mixte (hybride pour les pays autre que la France). Les traits colorés correspondent à chaque pays, les traits fins gris rappellent les autres pays.") ) 
