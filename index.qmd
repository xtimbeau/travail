...
Le processus de productif engage d'un côté des travailleurs, qu'ils soient salariés ou non salariés, et des apporteurs de capitaux, qu'ils soient investisseurs actionnaires, détenteurs de titres de dette ou prêteurs. La nature des contrats reliant chacun de ces intervenants au partage de la richesse produite est très diverse. Certains sont à la fois travailleurs et actionnaires — un entrepreuneur cumule les deux rôles, D'autres sont dans des positions radicalement différentes, comme entre un spécialiste de l'IA dont les bonus peuvent être considérables et un agent de maintenance en contrat précaire. Mais, bien que les frontières ne soient pas aussi nettes que ce que l'on peut souhaiter, ce qu'on appelle communément la part des salaires dans la valeur ajoutée est un indicateur central dans la mesure du conflit de répartition entre le travail et le capital.

Nous explorons ici la construction de cet indicateur afin qu'il reponde le mieux possible à la question posée, à savoir le confilt de répartatition. Cela nous anmène à privilégié la part des salaires *augmenté de la rémunération des non salariés par leur revenu mixte* dans la valeur ajouté *nette de la consommation de capital fixe* en se limitant *aux branches marchandes hors immobilier*.

Il apapraît que la part des salaires dans la valeur ajoutée en France est croissante depuis 30 ans (@fig-psal), est la plus haute quand à la compare à 5 grands Etats membre de la zone Euro. Ce résultat constraste avec le consensus qui s'est établit depuis le rapport Cotis [@cotis2009] et confirmé récemment par @cette2019, @pak2019 ou @tresor2025 que la part des salaires en France est constante depuis la fin des années 1980.
...
Le code peremttant de reproduire les graphiques et les tableaux est disponible dans un [dépôt github] (https://github.com/xtimbeau/travail) afin d'assurer la transparence et la reproductibilité des éléments produits.
...
tabsetize(psal, active = 2, r = 1.25)
```
...
### Le principe d'un partage entre salariés et financeurs
...
### Rendement financier du capital productif au plus bas en France
...
[^3]: La localisation de la dette bancaire dans des filiales dans des pays qui dégrèvent la dette de la base fiscale impôt sur les sociétés peut modifier le bilan des entreprises mais ne joue pas, au contraire des prix de transfert, sur la valeur ajoutée résidente. En revanche, un phénomène similaire à l'évaporation de la valeur ajoutée peut passer par le secteur immobilier. Voir à ce sujet la section @sec-immobilier.
