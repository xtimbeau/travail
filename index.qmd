...
Nous explorons ici la construction de cet indicateur afin qu'il reponde le mieux possible à la question posée, à savoir le confilt de répartatition. Cela nous anmène à privilégier la part des salaires *augmenté de la rémunération des non salariés par leur revenu mixte* dans la valeur ajouté *nette de la consommation de capital fixe* en se limitant *aux branches marchandes hors immobilier*.

Il apparaît que la part des salaires dans la valeur ajoutée en France est croissante depuis 30 ans (@fig-psal), est la plus haute quand à la compare à 5 grands Etats membre de la zone Euro. Ce résultat constraste avec le consensus qui s'est établit depuis le rapport Cotis [@cotis2009] et confirmé récemment par @cette2019, @pak2019 ou @tresor2025 que la part des salaires en France est constante depuis la fin des années 1980.
...
naq |>
  ...
  tab_source_note(md("*Note* : Part des salaires en 2024 dans les branches marchandes hors services immobiliers pour différentes mesure (VA nette ou brute, correction ou non pour les non salariés. Le rang est indiqué entre paranthèses. Voir annexe C pour les autres champs.")) |> 
...
La masse salariale est rapportée soit à la valeur ajoutée brute ($B1G$), soit à la valeur ajoutée nette ($B1N=B1G-P51C$). Comme la consommation de capital fixe ($P51C$) n'est pas connue en trimestriel, elle est dérivée des comptes annuels en 21 branches (niveau 1 de la NACE rev. 2 [`nama_10_a64`](#0)), agrégée en 9 branches, puis extrapolée pour les années non connues (ici 2024 et 2025) en conservant un ratio constant dans la valeur ajouté brute. Le détail se trouve dans le code.
