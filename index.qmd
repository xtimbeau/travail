...
champs  <- c("md" = "Branches marchandes", 
            ...
            "mdhim"= "Branches marchandes hors imm. des ménages (-L68AOPQ)", 
...
$$
s  = \frac{ \sum\limits_{b\in{-LOPQ}} D1_b*(1+ns_b/sal_b) } {\sum\limits_{b\in{-LOPQ}} B1G_b - P51C_b - (D29_b-D39_b)}
$$
...
psal <- ggplot() +
 ...
 comptes nationaux trimestriels (namq_10_a10), téléchargés le {date}, github.com/xtimbeau/travail/R/vaq.r.",
    champ = "Branches marchandes et non marchandes (en léger et pointillé) et branches marchandes hors services immobiliers des ménages (-L68A) (en plein), correction par le revenu mixte.")
...
gd <- ggplot(decomp) +
 ...
 champ = "Branches marchandes hors services immobiliers des ménages (L68A), correction par les effectifs.")
